...
class Database
{
     ...
     */
    function __construct($database_name, $username, $password, $host = 'localhost', $port = 3306)
    {
        self::$instance = $this;

        $this->database_name = $database_name;
        $this->mysql = mysqli_connect($host, $username, $password, $database_name, $port);
     ...
     * @return Database
     */
    final public static function instance($database_name = null, $username = null, $password = null, $host = 'localhost', $port = 3306)
    {
        if (!isset(self::$instance)) {
            self::$instance = new Database($database_name, $username, $password, $host, $port);
        }
    ...
    public function query($query)
    {
        ...
        Base::log(basename(__FILE__)." $this->sql");
